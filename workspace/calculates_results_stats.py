...
def calculates_results_stats(results_dic):
    ...
    """        
    #  create empty dictionary for statistics results
    results_stats_dic = dict()
    
    # number of images
    results_stats_dic['n_images'] = len(results_dic)
    
    # set other statistics calculations to 0
    ...
    for key in results_dic:
        # change number of correct dog matches
        if results_dic[key][3] == 1 and results_dic[key][4] == 1:
            results_stats_dic['n_correct_dogs'] += 1
        # change number of dog images
        if results_dic[key][3] == 1:
            results_stats_dic['n_dogs_img'] += 1
        # change number of correct non-dog matches 
        if results_dic[key][3] == 0 and results_dic[key][4] == 0:
            results_stats_dic['n_correct_notdogs'] += 1
        # change number of correct breed matches
        if results_dic[key][3] == 1 and results_dic[key][2] == 1:
            results_stats_dic['n_correct_breed'] += 1
        # change number of label matches
    ...
    # percentage label matches (regardless if they are a dog)
    if results_stats_dic['n_images'] > 0:
        results_stats_dic['pct_label_match'] = results_stats_dic['n_label_match'] / results_stats_dic['n_images']
    else:
        results_stats_dic['pct_label_match'] = 0
